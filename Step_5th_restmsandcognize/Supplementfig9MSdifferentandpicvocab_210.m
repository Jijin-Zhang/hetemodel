...
ms_100_2=ms_100;
load('HCP_Congnitivedata\100Picvocab.mat')
Picvocab2=Picvocab;
for brainindex=1:210
    MS=ms_100_2(:,brainindex);
    [r(brainindex),p(brainindex)]=corr(Picvocab2,MS);
end
min(r)
max(r)
...
[rr1,pp1]=corr(MS_positive,Picvocab2)
[rr2,pp2]=corr(MS_negative,Picvocab2)
[rr3,pp3]=corr(MS_diff,Picvocab2)
%%
...
% subplot(4,3,1:9)
% fig9=imread('fig9R_MSandPicvocab.png');
% imagesc(fig9)
% box on
% colormap('jet');
% caxis([-0.26 0.23])
...
set(gca,'FontName','Arial','FontSize',14,'LineWidth',1)
text(0.1,92,['r=0.2543' sprintf('\n') 'p=0.0107 '],'FontName','Arial','FontSize',18);
set(gca,'xtick',(0.06:.04:0.18),'ytick',(90:20:150))
...
ylabel( 'Picvocab','FontName','Arial','FontSize',18);
grid on
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[rr2,pp2]=corr(MS_negative,Picvocab2)
...
plot(x2,yi,'r-','linewidth',5);
set(gca,'FontName','Arial','FontSize',14,'LineWidth',1)
text(0.07,140,['r=-0.3611' sprintf('\n') 'p=0 '],'FontName','Arial','FontSize',18);
set(gca,'xtick',(0.07:.01:0.10),'ytick',(90:20:150))
set(gca,'xTickLabel',num2str(get(gca,'xTick')','%.2f'),'yTickLabel',num2str(get(gca,'yTick')','%.0f'))
xlim([0.07 0.1]);
ylim([90 155])
...
plot(x2,yi,'r-','linewidth',5);
set(gca,'FontName','Arial','FontSize',14,'LineWidth',1)
text(-0.03,140,['r=0.3511' sprintf('\n') 'p=0 '],'FontName','Arial','FontSize',18);
set(gca,'xtick',(-0.04:.04:0.088),'ytick',(90:20:150))
set(gca,'xTickLabel',num2str(get(gca,'xTick')','%.2f'),'yTickLabel',num2str(get(gca,'yTick')','%.0f'))
xlim([-0.04 0.085]);
ylim([90 155])
