...
%     donor{donor_id}.Probes_gene_corrsponse = [donor{donor_id}.Probes_gene_corrsponse,allen_updated.gene_symbol_update];
    donor{donor_id}.Probes_gene_corrsponse = [donor{donor_id}.Probes_gene_corrsponse,donor{donor_id}.Probes_gene_corrsponse.gene_symbol];
    donor{donor_id}.Probes_gene_corrsponse.Properties.VariableNames{8} = 'updated_symbol';
end
% donor{donor_id}.Probes_gene_corrsponse.gene_symbol  
% updated_symbol
